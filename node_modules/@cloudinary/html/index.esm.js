...
var HtmlImageLayer = /** @class */ (function () {
    function HtmlImageLayer(element, userCloudinaryImage, plugins) {
        ...
        var pluginCloudinaryImage = cloneDeep_1(userCloudinaryImage);
...
var ResizeSimpleAction$1 = ResizeSimpleAction;
 ...
 * @see Visit {@link Actions.Resize| Resize} for examples
 */
class ResizeAdvancedAction extends ResizeSimpleAction$1 {
    /**
...
var ResizeAdvancedAction$1 = ResizeAdvancedAction;
 ...
 * @see Visit {@link Actions.Resize| Resize} for examples
 */
class ResizePadAction extends ResizeAdvancedAction$1 {
    /**
...
var ResizePadAction$1 = ResizePadAction;
 ...
 * @see Visit {@link Actions.Resize| Resize} for examples
 */
class ScaleAction extends ResizeSimpleAction$1 {
    /**
 ...
 * @see Visit {@link Actions.Resize| Resize} for examples
 */
class ResizeCropAction extends ResizeAdvancedAction$1 {
    /**
...
var ResizeCropAction$1 = ResizeCropAction;
 ...
 * @see Visit {@link Actions.Resize| Resize} for examples
 */
class ResizeFillAction extends ResizeAdvancedAction$1 {
    /**
...
function crop(width, height) {
    return new ResizeCropAction$1('crop', width, height);
}
/**
 * @summary action
 * @description
...
function pad(width, height) {
    return new ResizePadAction$1('pad', width, height);
}
...
var HtmlVideoLayer = /** @class */ (function () {
    function HtmlVideoLayer(element, userCloudinaryVideo, sources, plugins, videoAttributes) {
        ...
        this.htmlPluginState = { cleanupCallbacks: [], pluginEventSubscription: [] };
        var pluginCloudinaryVideo = cloneDeep_1(userCloudinaryVideo);
    ...
    HtmlVideoLayer.prototype.generateUserSources = function (userCloudinaryVideo, sources) {
        ...
        sources.map(function (_a) {
            ...
            return (_this.appendSourceTag(cloneDeep_1(userCloudinaryVideo)
...
var HtmlPictureSourceLayer = /** @class */ (function () {
    ...
    HtmlPictureSourceLayer.prototype.generateSrcsetUrl = function (source) {
        ...
        breakpoints.forEach(function (breakPoint) {
            ...
            var clone = cloneDeep_1(_this.image);
 ...
 */
function lazyload(rootMargin, threshold) {
...
function preparePlaceholderTransformation(mode, pluginCloudinaryImage) {
    var placeholderClonedImage = cloneDeep_1(pluginCloudinaryImage);
    // @ts-ignore
...
function serverSideSrc(plugins, serverCloudinaryImage) {
    var clonedServerCloudinaryImage = cloneDeep_1(serverCloudinaryImage);
    if (plugins) {
...
export { HtmlImageLayer, HtmlPictureLayer, HtmlVideoLayer, accessibility, cancelCurrentlyRunningPlugins, isBrowser, lazyload, placeholder, responsive, serverSideSrc };
